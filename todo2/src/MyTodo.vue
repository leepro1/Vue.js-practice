...
export default { 
    ...
    methods: { 
        ...
        async addTodo() { 
            try { 
                const todo = {id: 0, title: this.title}; //id가 AI이기 때문에 자동으로 결정된다.
...
<style scoped>
    div#MyTodo { padding: 30px; margin: 30px auto; width: 400px; border: 1px solid #ccc; box-shadow: 3px 3px 3px #aaa; } 
